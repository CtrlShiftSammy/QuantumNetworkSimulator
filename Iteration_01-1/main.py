...
class optical_fiber:
    ...
    def transmit(fiber, photon, node, platform):
        ...
        dampening = 10 ** (-0.1 * 0.2 * fiber.length)
...
#length = 151.6
length = 202.1
signal_mean_photon_number = 0.39
decoy_mean_photon_number = 0.18
alice_station_key = ""
alice_station_basis = ""
bob_station_raw_key = ""
...
# anil prabhakar iit madras, orn iit delhi bhaskar kansari wih drdo bkanseri@physics.iitd.ac.in

# rri and rp singh is entangled photon source