...
lines = 10001
alpha_file = open("Iteration_01/data/SiO2_alpha_vs_lambda.csv")
...
alpha_file.close()
platforms = 6
platform_file = open("Iteration_01/data/QR_platform_parameters_current.csv")
platform_names = []
